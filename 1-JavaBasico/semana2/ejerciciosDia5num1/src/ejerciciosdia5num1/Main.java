...
package ejerciciosdia5num1;

import ejerciciosdia5num1.Models.Animal;
import ejerciciosdia5num1.Models.Bird;
import ejerciciosdia5num1.Models.Mammal;
import ejerciciosdia5num1.Models.Reptile;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        animalMammal.saludar();
        animalBird.saludar();
        animalReptile.saludar();
        
       // Mammal animal = new Animal(); es incompatible ya que la Clase principal es Animal
        
       
       //E) Cambiar el modificador de acceso de los métodos de "public" a "private". Intentar acceder desde el "main" a estos métodos. ¿Qué sucede? ¿Es posible hacer esto?

        // si cambio el modificador a private no podre llamar a los metodos ya que debe estar en la misma clase para poder hacerlo.
